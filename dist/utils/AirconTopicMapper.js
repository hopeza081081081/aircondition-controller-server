...
class AirconTopicMapper {
    ...
    getControllerId(topic) {
        ...
        Logger.info(`New aircon controller detected: '${identifier}' auto-assigned to index ${newIndex}`, {
            identifier,
            index: newIndex,
            topic,
        });
     ...
     */
    isAirconControllerTopic(topic) {
        const pattern = /\/airconController\/aircon_([A-F0-9]{12})\//i;
        return pattern.test(topic);
    }
}
exports.default = AirconTopicMapper;
//# sourceMappingURL=AirconTopicMapper.js.map